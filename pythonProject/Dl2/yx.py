...
if __name__ == '__main__':
    ...
    wy.dwf('login_frame')
    #点击请求头像
    wy.ss("id","img_out_1870564096").click()
    #选择最新标签页
    wy.dww()
    time.sleep(3)
    #点击写信
    ...
    #在主题输入：嗯嗯饿呢嗯嗯嗯嗯啊
    wy.ss("xpath",'//*[@id="subject"]').send_keys('铁废物')
    time.sleep(3)
    #上传附件：1.txt
    wy.ss("name","UploadFile").send_keys("C:\\JK\\666.txt")
    time.sleep(2)
    #定位正文框架
    wy.dwf(wy.ss("xpath",'//*[@class="qmEditorIfrmEditArea"]'))
    #正文输入：厄内阿斯顿ask多久啊我看等哈我的
    wy.ss("xpath",'/html/body/div').send_keys('关于二十多岁还不会火之呼吸')
    time.sleep(4)
    #回退到上一个框架
    wy.dwpf()
    time.sleep(1)
